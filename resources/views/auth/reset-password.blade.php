...
@section('content')
    <div class="auth-page-centered">
        <div class="auth-card-single">
            ...
            <p class="auth-subtitle">Saisis ton nouveau mot de passe ci-dessous pour sécuriser à nouveau ton compte.</p>
            ...
            <form method="POST" action="{{ route('password.update') }}" class="auth-form">
                ...
                <div class="auth-field">
                    ...
                    <input type="password" id="password" name="password" placeholder="Entre ton nouveau mot de passe" required>
                </div>

                <div class="auth-field">
                    <label for="password_confirmation">Confirmer le mot de passe</label>
                    <input type="password" id="password_confirmation" name="password_confirmation" placeholder="Confirme ton nouveau mot de passe" required>
                </div>
